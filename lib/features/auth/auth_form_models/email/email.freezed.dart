...
mixin _$EmailValidationError {
  ...
  @JsonKey(ignore: true)
  $EmailValidationErrorCopyWith<EmailValidationError> get copyWith =>
...
class _$_EmailValidationError implements _EmailValidationError {
  ...
  @override
  String toString() {
    return 'EmailValidationError(validationMessage: $validationMessage)';
  }
...
abstract class _EmailValidationError implements EmailValidationError {
